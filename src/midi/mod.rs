//! MIDI Learn module for **Nebula Delay** by Nebula Audio.
//!
...
pub const MIDI_TARGET_COUNT: usize = 17;
...
impl MidiTarget {
    ...
    pub fn from_index(index: usize) -> Option<Self> {
        match index {
            ...
            5 => Some(Self::DoubleL),
            6 => Some(Self::LowCutL),
            7 => Some(Self::LowCutSlopeL),
            8 => Some(Self::HighCutL),
            9 => Some(Self::HighCutSlopeL),
            10 => Some(Self::FeedbackL),
            11 => Some(Self::FeedbackPhaseL),
            12 => Some(Self::TempoSync),
            13 => Some(Self::OutputMixL),
            14 => Some(Self::OutputMixR),
            15 => Some(Self::Oversampling),
            16 => Some(Self::Bypass),
            _ => None,
        }
    }
    ...
    pub fn from_param_id(param_id: &str) -> Option<Self> {
        match param_id {
            ...
            "delay_time" | "delay_time_l" | "delay_time_r" => Some(Self::DelayTimeL),
            "note" | "note_l" | "note_r" => Some(Self::NoteL),
            "halve" | "halve_l" | "halve_r" => Some(Self::HalveL),
            "double" | "double_l" | "double_r" => Some(Self::DoubleL),
            "low_cut" | "low_cut_l" | "low_cut_r" => Some(Self::LowCutL),
            "low_cut_slope" | "low_cut_slope_l" | "low_cut_slope_r" => Some(Self::LowCutSlopeL),
            "high_cut" | "high_cut_l" | "high_cut_r" => Some(Self::HighCutL),
            "high_cut_slope" | "high_cut_slope_l" | "high_cut_slope_r" => Some(Self::HighCutSlopeL),
            "feedback" | "feedback_l" | "feedback_r" => Some(Self::FeedbackL),
            "feedback_phase" | "feedback_phase_l" | "feedback_phase_r" => {
                Some(Self::FeedbackPhaseL)
            }
            "tempo_sync" => Some(Self::TempoSync),
            "dry_level" | "output_mix_l" => Some(Self::OutputMixL),
            "wet_level" | "output_mix_r" => Some(Self::OutputMixR),
