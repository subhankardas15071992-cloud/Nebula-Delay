...
VERSION="1.0.0"
BUNDLE_ID="audio.nebula.NebulaDelay"
VENDOR="Nebula Audio"
...
echo -e ""
echo -e "${BOLD}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BOLD}║  Nebula Delay — macOS Universal Build                      ║${NC}"
...
mkdir -p "${BUILD_DIR}"
rm -rf "${BUILD_DIR}/${PLUGIN_NAME}.component" "${BUILD_DIR}/${PACKAGE_NAME}-macos-auv2.zip"
